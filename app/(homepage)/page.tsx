...
export default function Home() {
  return (
    <>
      ...
      <section
        id="hero"
        className="px-6 bg-[url(/bg/bg-1.svg)] bg-no-repeat bg-cover bg-center"
      >
      ...
      <section
        id="intro"
        className="md:px-6 bg-white pb-20 -mt-10 z-[1] pt-12 md:py-20 rounded-tl-[40px] rounded-tr-[40px]"
      >
        <div className="container">
